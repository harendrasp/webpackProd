...
var routeComponents = function routeComponents() {
  return {
    component: _Home2.default,
    path: '/',
    indexRoute: {
      component: _ArtistMain2.default
    },
    childRoutes: [{
      path: 'artists/new',
...
var Routes = function Routes() {
  return _react2.default.createElement(_reactRouter.Router, { history: _reactRouter.hashHistory, routes: routeComponents() });
};
